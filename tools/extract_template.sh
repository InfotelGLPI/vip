...
xgettext *.php */*.php --copyright-holder='VIP Development Team' --package-name='GLPI - VIP plugin' --package-version='1.4.0' -o locales/glpi.pot -L PHP --add-comments=TRANS --from-code=UTF-8 --force-po  \
